    ...
    <header className={`sticky top-0 z-50 ${darkMode ? "bg-gray-800" : "bg-white"} shadow-md`}>
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="space-x-6 hidden md:flex">
          ...
          <a href="#proyectos" className="hover:text-maptiva-green-medium">Proyectos</a>
          <a href="#nosotros" className="hover:text-maptiva-green-medium">Nosotros</a>
          <a href="#contacto" className="hover:text-maptiva-green-medium">Contacto</a>
        </nav>
